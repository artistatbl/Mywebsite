        ...
        <Layout className='pt-0'>
          <div className='flex items-center justify-between w-full'>
            ...
            <div className='w-1/2 flex flex-col items-center self-center'>
              <Animated text="I build things for the web." className=' !text-7xl text-left' />
              ...
              <div className="flex items-center self-start mt-2 space-x-4">
                ...
                <Link href="/" target={"_blank"}
                  ...
                  rounded-lg text-lg font-semibold ring-2 ring-blue-500 ring-inset
                  hover:bg-indigo-500 hover:text-light border-2 border-solid border-light hover:border-dark
                  shadow-md transition duration-300 ease-in-out transform hover:scale-105"
                >
